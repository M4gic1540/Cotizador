...
class CustomUser(AbstractUser):
    ...
    rut = models.CharField(max_length=12, unique=True,
                           help_text="RUT del usuario (único).")
    telefono = models.CharField(
        max_length=15, help_text="Número de teléfono del usuario.")
    email = models.EmailField(
        unique=True, help_text="Correo electrónico único del usuario.")
...
class Categoria(models.Model):
    ...
    nombre = models.CharField(
        max_length=50, unique=True, help_text="Nombre de la categoría (único).")
...
class Producto(models.Model):
    ...
    descripcion = models.TextField(
        blank=True, help_text="Descripción detallada del producto (opcional).")
    precio = models.DecimalField(
        max_digits=10, decimal_places=2, help_text="Precio unitario del producto.")
...
class Cotizacion(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, help_text="Usuario que realizó la cotización.")
    fecha = models.DateTimeField(
        auto_now_add=True, help_text="Fecha y hora de creación de la cotización.")
...
class DetalleFactura(models.Model):
    ...
    precio_unitario = models.DecimalField(
        max_digits=10, decimal_places=2, help_text="Precio unitario aplicado.")
